...
FOCUS_SPELLCASTS_TO_TRACK = {
 -- MISC & MOB SPELLS
  ...
  ['闪电吐息'] = {['icon'] = [[Interface\Icons\spell_nature_lightning]], ['casttime'] = 2},
  ...
  ['落雷之云'] = {['icon'] = [[Interface\Icons\Spell_Nature_CallStorm]], ['casttime'] = 3},
  -- AHN'QIRAJ
...
--  ['Evocation']  = {[[Interf ace\Icons\Spell_nature_purge]], 8},
  ['火球术']   = {['icon'] = [[Interface\Icons\Spell_fire_flamebolt]], ['casttime'] = 3, ['class'] = '法师', ['type'] = 'dmg', ['school'] = 'fire', },
