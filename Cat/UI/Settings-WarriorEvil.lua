...
slider_NearbyEnemies_Value:SetScript("OnValueChanged", function()
    ...
    MPWarriorEvilSaved.NearbyEnemies_Value = arg1
    _G[slider_NearbyEnemies_Value:GetName().."Text"]:SetText(color_NearbyEnemies.."感应范围".. MPWarriorEvilSaved.NearbyEnemies_Value .."码|r")
end)
...
-- 配置文件版本号
local WarriorEvilSettingsUIVersion = 2
...
function MPResetWarriorEvilSettings()
    ...
    MPWarriorEvilSaved.Target = 0
    MPWarriorEvilSaved.NearbyEnemies = 1
    MPWarriorEvilSaved.NearbyEnemies_Value = 8
...
local function InitWarriorEvilSettingsPart1()
    ...
    slider_NearbyEnemies_Value:SetValue(MPWarriorEvilSaved.NearbyEnemies_Value)
