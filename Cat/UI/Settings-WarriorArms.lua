...
-- 创建主框架
CatUISettingsWarriorArms = MPCreateFrame(ADDON_NAME.."Frame", 520, 600, "|cFFC79C6E设置 - 武器战|r")
...
-- 创建单选框 - 狂暴姿态
local checkButton_BerserkerStance = CreateFrame("CheckButton", ADDON_NAME.."CheckButton", CatUISettingsWarriorArms, "UICheckButtonTemplate")
checkButton_BerserkerStance:SetPoint("TOPLEFT", CatUISettingsWarriorArms, "TOPLEFT", 20, postion_y)
...
checkButton_BerserkerStance:SetScript("OnClick", function(self)
    if this:GetChecked() then
        MPWarriorArmsSaved.BerserkerStance = 1
    else
        MPWarriorArmsSaved.BerserkerStance = 0
    end
end)
...
-- 创建单选框 - 上方饰品
local checkButton_Trinket_Upper = CreateFrame("CheckButton", ADDON_NAME.."CheckButton", CatUISettingsWarriorArms, "UICheckButtonTemplate")
checkButton_Trinket_Upper:SetPoint("TOPLEFT", CatUISettingsWarriorArms, "TOPLEFT", 340, postion_y)
...
checkButton_Trinket_Upper:SetScript("OnClick", function(self)
    if this:GetChecked() then
        MPWarriorArmsSaved.Trinket_Upper = 1
    else
        MPWarriorArmsSaved.Trinket_Upper = 0
    end
end)

local checkButton_TUBoss = MPCreateCheckButtonSmall(CatUISettingsWarriorArms, ADDON_NAME.."CheckButton", 520, postion_y, "仅BOSS")
checkButton_TUBoss:SetScript("OnClick", function(self)
    if this:GetChecked() then
        MPWarriorArmsSaved.TUBoss = 1
    else
        MPWarriorArmsSaved.TUBoss = 0
    end
end)
...
-- 创建单选框 - 战斗怒吼
local checkButton_BattleShout = CreateFrame("CheckButton", ADDON_NAME.."CheckButton", CatUISettingsWarriorArms, "UICheckButtonTemplate")
checkButton_BattleShout:SetPoint("TOPLEFT", CatUISettingsWarriorArms, "TOPLEFT", 20, postion_y)
...
checkButton_BattleShout:SetScript("OnClick", function(self)
    if this:GetChecked() then
        MPWarriorArmsSaved.BattleShout = 1
    else
        MPWarriorArmsSaved.BattleShout = 0
    end
end)


-- 创建单选框 - 下方饰品
local checkButton_Trinket_Below = CreateFrame("CheckButton", ADDON_NAME.."CheckButton", CatUISettingsWarriorArms, "UICheckButtonTemplate")
checkButton_Trinket_Below:SetPoint("TOPLEFT", CatUISettingsWarriorArms, "TOPLEFT", 340, postion_y)
...
checkButton_Trinket_Below:SetScript("OnClick", function(self)
    if this:GetChecked() then
        MPWarriorArmsSaved.Trinket_Below = 1
    else
        MPWarriorArmsSaved.Trinket_Below = 0
    end
end)

local checkButton_TBBoss = MPCreateCheckButtonSmall(CatUISettingsWarriorArms, ADDON_NAME.."CheckButton", 520, postion_y, "仅BOSS")
checkButton_TBBoss:SetScript("OnClick", function(self)
    if this:GetChecked() then
        MPWarriorArmsSaved.TBBoss = 1
    else
        MPWarriorArmsSaved.TBBoss = 0
    end
end)
...
-- 创建单选框 - 血性狂暴
local checkButton_BerserkerRage = CreateFrame("CheckButton", ADDON_NAME.."CheckButton", CatUISettingsWarriorArms, "UICheckButtonTemplate")
checkButton_BerserkerRage:SetPoint("TOPLEFT", CatUISettingsWarriorArms, "TOPLEFT", 20, postion_y)
...
checkButton_BerserkerRage:SetScript("OnClick", function(self)
    if this:GetChecked() then
        MPWarriorArmsSaved.BerserkerRage = 1
    else
        MPWarriorArmsSaved.BerserkerRage = 0
    end
end)
...
-- 创建单选框 - 自动锁敌
local checkButton_Target = CreateFrame("CheckButton", ADDON_NAME.."CheckButton", CatUISettingsWarriorArms, "UICheckButtonTemplate")
checkButton_Target:SetPoint("TOPLEFT", CatUISettingsWarriorArms, "TOPLEFT", 340, postion_y)
...
checkButton_Target:SetScript("OnClick", function(self)
    if this:GetChecked() then
        MPWarriorArmsSaved.Target = 1
    else
        MPWarriorArmsSaved.Target = 0
    end
end)
...
-- 创建单选框 - 旋风斩
local checkButton_Whirlwind = CreateFrame("CheckButton", ADDON_NAME.."CheckButton", CatUISettingsWarriorArms, "UICheckButtonTemplate")
checkButton_Whirlwind:SetPoint("TOPLEFT", CatUISettingsWarriorArms, "TOPLEFT", 20, postion_y)
...
checkButton_Whirlwind:SetScript("OnClick", function(self)
    if this:GetChecked() then
        MPWarriorArmsSaved.Whirlwind = 1
    else
        MPWarriorArmsSaved.Whirlwind = 0
    end
end)
...
-- 创建单选框 - 单体/群体
local checkButton_NearbyEnemies = CreateFrame("CheckButton", ADDON_NAME.."CheckButton", CatUISettingsWarriorArms, "UICheckButtonTemplate")
checkButton_NearbyEnemies:SetPoint("TOPLEFT", CatUISettingsWarriorArms, "TOPLEFT", 340, postion_y)
...
checkButton_NearbyEnemies:SetScript("OnClick", function(self)
    if this:GetChecked() then
        MPWarriorArmsSaved.NearbyEnemies = 1
    else
        MPWarriorArmsSaved.NearbyEnemies = 0
    end
end)
...
-- 创建单选框 - 斩杀
local checkButton_UseExecute = CreateFrame("CheckButton", ADDON_NAME.."CheckButton", CatUISettingsWarriorArms, "UICheckButtonTemplate")
checkButton_UseExecute:SetPoint("TOPLEFT", CatUISettingsWarriorArms, "TOPLEFT", 20, postion_y)
...
checkButton_UseExecute:SetScript("OnClick", function(self)
    if this:GetChecked() then
        MPWarriorArmsSaved.UseExecute = 1
    else
        MPWarriorArmsSaved.UseExecute = 0
    end
end)
...
-- 创建单选框 - 冲锋/拦截
local checkButton_Charge = CreateFrame("CheckButton", ADDON_NAME.."CheckButton", CatUISettingsWarriorArms, "UICheckButtonTemplate")
checkButton_Charge:SetPoint("TOPLEFT", CatUISettingsWarriorArms, "TOPLEFT", 20, postion_y)
...
checkButton_Charge:SetScript("OnClick", function(self)
    if this:GetChecked() then
        MPWarriorArmsSaved.Charge = 1
    else
        MPWarriorArmsSaved.Charge = 0
    end
end)
...
-- 创建单选框 - 横扫
local checkButton_Sweeping = CreateFrame("CheckButton", ADDON_NAME.."CheckButton", CatUISettingsWarriorArms, "UICheckButtonTemplate")
checkButton_Sweeping:SetPoint("TOPLEFT", CatUISettingsWarriorArms, "TOPLEFT", 20, postion_y)
...
slider_Sweeping:SetScript("OnValueChanged", function()
    ...
    MPWarriorArmsSaved.Sweeping_Value = arg1
...
checkButton_Sweeping:SetScript("OnClick", function(self)
    if this:GetChecked() then
        MPWarriorArmsSaved.Sweeping = 1
        color_Sweeping = "|cFFFFD100"
        _G[slider_Sweeping:GetName().."Text"]:SetText(color_Sweeping.."怒气 < ".. MPWarriorArmsSaved.Sweeping_Value)
    else
        MPWarriorArmsSaved.Sweeping = 0
...
-- 创建单选框 - 治疗石
local checkButton_HealthStone = CreateFrame("CheckButton", ADDON_NAME.."CheckButton", CatUISettingsWarriorArms, "UICheckButtonTemplate")
checkButton_HealthStone:SetPoint("TOPLEFT", CatUISettingsWarriorArms, "TOPLEFT", 340, postion_y)
...
slider_HealthStone:SetScript("OnValueChanged", function()
    ...
    MPWarriorArmsSaved.HealthStone_Value = arg1
    _G[slider_HealthStone:GetName().."Text"]:SetText(color_HealthStone.."血线: ".. MPWarriorArmsSaved.HealthStone_Value .."%|r")
end)

-- 设置点击事件
checkButton_HealthStone:SetScript("OnClick", function(self)
    if this:GetChecked() then
        MPWarriorArmsSaved.HealthStone = 1
        color_HealthStone = "|cFFFFD100"
        _G[slider_HealthStone:GetName().."Text"]:SetText(color_HealthStone.."血线: ".. MPWarriorArmsSaved.HealthStone_Value .."%|r")
    else
        MPWarriorArmsSaved.HealthStone = 0
...
-- 创建单选框 - 压制
local checkButton_Overpower = CreateFrame("CheckButton", ADDON_NAME.."CheckButton", CatUISettingsWarriorArms, "UICheckButtonTemplate")
checkButton_Overpower:SetPoint("TOPLEFT", CatUISettingsWarriorArms, "TOPLEFT", 20, postion_y)
...
slider_Overpower:SetScript("OnValueChanged", function()
    --print("HerbalTea当前值:", arg1)
    MPWarriorArmsSaved.Overpower_Value = arg1
...
checkButton_Overpower:SetScript("OnClick", function(self)
    if this:GetChecked() then
        MPWarriorArmsSaved.Overpower = 1
        color_Overpower = "|cFFFFD100"
        _G[slider_Overpower:GetName().."Text"]:SetText(color_Overpower.."怒气 < ".. MPWarriorArmsSaved.Overpower_Value)
    else
        MPWarriorArmsSaved.Overpower = 0
...
-- 创建单选框 - 草药茶
local checkButton_HerbalTea = CreateFrame("CheckButton", ADDON_NAME.."CheckButton", CatUISettingsWarriorArms, "UICheckButtonTemplate")
checkButton_HerbalTea:SetPoint("TOPLEFT", CatUISettingsWarriorArms, "TOPLEFT", 340, postion_y)
...
slider_HerbalTea:SetScript("OnValueChanged", function()
    --print("HerbalTea当前值:", arg1)
    MPWarriorArmsSaved.HerbalTea_Value = arg1
    _G[slider_HerbalTea:GetName().."Text"]:SetText(color_HerbalTea.."血线: ".. MPWarriorArmsSaved.HerbalTea_Value .."%|r")
end)

-- 设置点击事件
checkButton_HerbalTea:SetScript("OnClick", function(self)
    if this:GetChecked() then
        MPWarriorArmsSaved.HerbalTea = 1
        color_HerbalTea = "|cFFFFD100"
        _G[slider_HerbalTea:GetName().."Text"]:SetText(color_HerbalTea.."血线: ".. MPWarriorArmsSaved.HerbalTea_Value .."%|r")
    else
        MPWarriorArmsSaved.HerbalTea = 0
...
-- 破甲
local checkButton_SunderArmor = CreateFrame("CheckButton", ADDON_NAME.."CheckButton", CatUISettingsWarriorArms, "UICheckButtonTemplate")
checkButton_SunderArmor:SetPoint("TOPLEFT", CatUISettingsWarriorArms, "TOPLEFT", 20, postion_y)
...
checkButton_SunderArmor:SetScript("OnClick", function(self)
    if this:GetChecked() then
        MPWarriorArmsSaved.SunderArmor = 1
    else
        MPWarriorArmsSaved.SunderArmor = 0
    end
end)

local checkButton_SunderArmorBOSS = MPCreateCheckButtonSmall(CatUISettingsWarriorArms, ADDON_NAME.."CheckButton", 140, postion_y, "仅BOSS")
checkButton_SunderArmorBOSS:SetScript("OnClick", function(self)
    if this:GetChecked() then
        MPWarriorArmsSaved.SunderArmorBOSS = 1
    else
        MPWarriorArmsSaved.SunderArmorBOSS = 0
    end
end)
...
checkButton_SunderArmorOnce:SetScript("OnClick", function(self)
    if this:GetChecked() then
        MPWarriorArmsSaved.SunderArmorOnce = 1
    else
        MPWarriorArmsSaved.SunderArmorOnce = 0
    end
end)
...
-- 创建单选框 - 鞭根块茎
local checkButton_Carrot = CreateFrame("CheckButton", ADDON_NAME.."CheckButton", CatUISettingsWarriorArms, "UICheckButtonTemplate")
checkButton_Carrot:SetPoint("TOPLEFT", CatUISettingsWarriorArms, "TOPLEFT", 340, postion_y)
...
slider_Carrot:SetScript("OnValueChanged", function()
    --print("HerbalTea当前值:", arg1)
    MPWarriorArmsSaved.Carrot_Value = arg1
    _G[slider_Carrot:GetName().."Text"]:SetText(color_Carrot.."血线: ".. MPWarriorArmsSaved.Carrot_Value .."%|r")
end)

-- 设置点击事件
checkButton_Carrot:SetScript("OnClick", function(self)
    if this:GetChecked() then
        MPWarriorArmsSaved.Carrot = 1
        color_Carrot = "|cFFFFD100"
        _G[slider_Carrot:GetName().."Text"]:SetText(color_Carrot.."血线: ".. MPWarriorArmsSaved.Carrot_Value .."%|r")
    else
        MPWarriorArmsSaved.Carrot = 0
...
-- 创建单选框 - 斩杀嵌入主技能
local checkButton_ExecuteWithMortal = CreateFrame("CheckButton", ADDON_NAME.."CheckButton", CatUISettingsWarriorArms, "UICheckButtonTemplate")
checkButton_ExecuteWithMortal:SetPoint("TOPLEFT", CatUISettingsWarriorArms, "TOPLEFT", 20, postion_y)
checkButton_ExecuteWithMortal:SetScale(0.8)

-- 添加文字标签
local checkText_ExecuteWithMortal = checkButton_ExecuteWithMortal:CreateFontString(nil, "OVERLAY", "GameFontNormalSmall")
checkText_ExecuteWithMortal:SetFont("Fonts\\FRIZQT__.TTF", 16, "OUTLINE")
checkText_ExecuteWithMortal:SetTextColor(1, 1, 1)
checkText_ExecuteWithMortal:SetPoint("LEFT", checkButton_ExecuteWithMortal, "LEFT", 34, 1)
checkText_ExecuteWithMortal:SetText("开启 斩杀期嵌入主技能")

-- 设置点击事件
checkButton_ExecuteWithMortal:SetScript("OnClick", function(self)
    if this:GetChecked() then
        MPWarriorArmsSaved.ExecuteWithMortal = 1
    else
        MPWarriorArmsSaved.ExecuteWithMortal = 0
    end
end)

--[[
-- 创建单选框 - 断筋
local checkButton_Hamstring = CreateFrame("CheckButton", ADDON_NAME.."CheckButton", CatUISettingsWarriorArms, "UICheckButtonTemplate")
checkButton_Hamstring:SetPoint("TOPLEFT", CatUISettingsWarriorArms, "TOPLEFT", 20, postion_y)
checkButton_Hamstring:SetScale(0.8)
checkButton_Hamstring:Hide()
...
checkButton_Hamstring:SetScript("OnClick", function(self)
    if this:GetChecked() then
        MPWarriorArmsSaved.Hamstring = 1
    else
        MPWarriorArmsSaved.Hamstring = 0
    end
end)
]]

-- 魂能之速
local checkButton_Soulspeed = CreateFrame("CheckButton", ADDON_NAME.."CheckButton", CatUISettingsWarriorArms, "UICheckButtonTemplate")
checkButton_Soulspeed:SetPoint("TOPLEFT", CatUISettingsWarriorArms, "TOPLEFT", 340, postion_y)
...
checkButton_Soulspeed:SetScript("OnClick", function(self)
    if this:GetChecked() then
        MPWarriorArmsSaved.Soulspeed = 1
    else
        MPWarriorArmsSaved.Soulspeed = 0
    end
end)
...
-- 创建单选框 - 斩杀周围目标
local checkButton_ExecuteOtherTarget = CreateFrame("CheckButton", ADDON_NAME.."CheckButton", CatUISettingsWarriorArms, "UICheckButtonTemplate")
checkButton_ExecuteOtherTarget:SetPoint("TOPLEFT", CatUISettingsWarriorArms, "TOPLEFT", 20, postion_y)
...
checkButton_ExecuteOtherTarget:SetScript("OnClick", function(self)
    if this:GetChecked() then
        MPWarriorArmsSaved.ExecuteOtherTarget = 1
    else
        MPWarriorArmsSaved.ExecuteOtherTarget = 0
    end
end)


-- 创建单选框 - 死亡之愿
local checkButton_DeathWish = CreateFrame("CheckButton", ADDON_NAME.."CheckButton", CatUISettingsWarriorArms, "UICheckButtonTemplate")
checkButton_DeathWish:SetPoint("TOPLEFT", CatUISettingsWarriorArms, "TOPLEFT", 340, postion_y)
checkButton_DeathWish:SetScale(0.8)
checkButton_DeathWish:Hide()
...
checkButton_DeathWish:SetScript("OnClick", function(self)
    if this:GetChecked() then
        MPWarriorArmsSaved.DeathWish = 1
    else
        MPWarriorArmsSaved.DeathWish = 0
    end
end)
...
-- 创建单选框 - 小怪断条猛击斩杀
local checkButton_ExecuteWithoutMonster = CreateFrame("CheckButton", ADDON_NAME.."CheckButton", CatUISettingsWarriorArms, "UICheckButtonTemplate")
checkButton_ExecuteWithoutMonster:SetPoint("TOPLEFT", CatUISettingsWarriorArms, "TOPLEFT", 20, postion_y)
...
checkButton_ExecuteWithoutMonster:SetScript("OnClick", function(self)
    if this:GetChecked() then
        MPWarriorArmsSaved.ExecuteWithoutMonster = 1
    else
        MPWarriorArmsSaved.ExecuteWithoutMonster = 0
    end
end)
...
-- 创建单选框 - 英勇/顺劈
local checkButton_HeroicStrike = CreateFrame("CheckButton", ADDON_NAME.."CheckButton", CatUISettingsWarriorArms, "UICheckButtonTemplate")
checkButton_HeroicStrike:SetPoint("TOPLEFT", CatUISettingsWarriorArms, "TOPLEFT", 20, postion_y)
...
slider_HeroicStrike:SetScript("OnValueChanged", function()
    --print("HerbalTea当前值:", arg1)
    MPWarriorArmsSaved.HeroicStrike_Value = arg1
...
checkButton_HeroicStrike:SetScript("OnClick", function(self)
    if this:GetChecked() then
        MPWarriorArmsSaved.HeroicStrike = 1
        color_HeroicStrike = "|cFFFFD100"
        _G[slider_HeroicStrike:GetName().."Text"]:SetText(color_HeroicStrike.."怒气 > ".. MPWarriorArmsSaved.HeroicStrike_Value)
    else
        MPWarriorArmsSaved.HeroicStrike = 0
...
slider_Slam:SetScript("OnValueChanged", function()
    MPWarriorArmsSaved.Slam_Value = arg1
...
-- 创建单选框 - 种族天赋
local checkButton_RacialTraits = CreateFrame("CheckButton", ADDON_NAME.."CheckButton", CatUISettingsWarriorArms, "UICheckButtonTemplate")
checkButton_RacialTraits:SetPoint("TOPLEFT", CatUISettingsWarriorArms, "TOPLEFT", 340, postion_y)
...
checkButton_RacialTraits:SetScript("OnClick", function(self)
    if this:GetChecked() then
        MPWarriorArmsSaved.RacialTraits = 1
    else
        MPWarriorArmsSaved.RacialTraits = 0
    end
end)
...
-- 创建单选框 - 自动打断
local checkButton_Interrupt = CreateFrame("CheckButton", ADDON_NAME.."CheckButton", CatUISettingsWarriorArms, "UICheckButtonTemplate")
checkButton_Interrupt:SetPoint("TOPLEFT", CatUISettingsWarriorArms, "TOPLEFT", 340, postion_y)
...
checkButton_Interrupt:SetScript("OnClick", function(self)
    if this:GetChecked() then
        MPWarriorArmsSaved.Interrupt = 1
    else
        MPWarriorArmsSaved.Interrupt = 0
    end
end)
...
-- 创建按钮
local myButton = CreateFrame("Button", ADDON_NAME.."ButtonReset", CatUISettingsWarriorArms, "UIPanelButtonTemplate")
myButton:SetPoint("TOPLEFT", CatUISettingsWarriorArms, "TOPLEFT", 120, -44)
...
local checkButton_Power = MPPublicCheckButton(CatUISettingsWarriorArms, ADDON_NAME.."CheckButton", 20, 40, "启动 功能药水")
checkButton_Power:SetScript("OnClick", function(self)
    if this:GetChecked() then
        MPWarriorArmsSaved.Power = 1
    else
        MPWarriorArmsSaved.Power = 0
    end
end)

local ButtonPower = MPPublicButton(CatUISettingsWarriorArms, ADDON_NAME.."CheckButton", "设置", 150, 34, 80, 22)
...
local checkButton_Pick = MPPublicCheckButton(CatUISettingsWarriorArms, ADDON_NAME.."CheckButton", 340, 40, "启动 自动拾取")
checkButton_Pick:SetScript("OnClick", function(self)
    if this:GetChecked() then
        MPWarriorArmsSaved.Pick = 1
    else
        MPWarriorArmsSaved.Pick = 0
    end
end)

local ButtonPick = MPPublicButton(CatUISettingsWarriorArms, ADDON_NAME.."CheckButton", "设置", 405, 34, 80, 22)
...
TipText:SetText("宏命令 -  [ 全自动 |cFFC79C6E/arms|r ]  [ 纯单体(防ADD) |cFFC79C6E/armso|r ]")



-- 配置文件版本号
local WarriorArmsSettingsUIVersion = 21

function MPResetWarriorArmsSettings()
    ...
    -- 高级配置
    MPWarriorArmsSaved.HeroicStrike = 0
    MPWarriorArmsSaved.HeroicStrike_Value = 50

    MPWarriorArmsSaved.Sweeping = 0
    MPWarriorArmsSaved.Sweeping_Value = 50
    MPWarriorArmsSaved.Overpower = 0
    MPWarriorArmsSaved.Overpower_Value = 30
    MPWarriorArmsSaved.Rend = 0
    MPWarriorArmsSaved.Rend_Value = 30
    MPWarriorArmsSaved.Slam_Value = 1.5
    MPWarriorArmsSaved.Hamstring = 1
    MPWarriorArmsSaved.SunderArmor = 0
    MPWarriorArmsSaved.SunderArmorBOSS = 0
    MPWarriorArmsSaved.SunderArmorOnce = 0
    ...
    MPWarriorArmsSaved.Interrupt = 0
    MPWarriorArmsSaved.DeathWish = 0
    MPWarriorArmsSaved.Recklessness = 0
    MPWarriorArmsSaved.RacialTraits = 0
    MPWarriorArmsSaved.Execute = 0
    MPWarriorArmsSaved.ExecuteWithMortal = 0
    MPWarriorArmsSaved.ExecuteOtherTarget = 0
    MPWarriorArmsSaved.ExecuteWithoutMonster = 1
    ...
    -- 治疗石、糖水茶
    MPWarriorArmsSaved.HealthStone = 1
    MPWarriorArmsSaved.HealthStone_Value = 30
    MPWarriorArmsSaved.HerbalTea = 1
    MPWarriorArmsSaved.HerbalTea_Value = 20
    MPWarriorArmsSaved.Carrot = 0
    MPWarriorArmsSaved.Carrot_Value = 20

    -- SuperWoW,UnitXP
    MPWarriorArmsSaved.SuperWoW = 1
    MPWarriorArmsSaved.UnitXP = 1
...
local function InitWarriorArmsSettingsPart1()
    checkButton_BerserkerStance:SetChecked(ToBoolean(MPWarriorArmsSaved.BerserkerStance))
    checkButton_BerserkerRage:SetChecked(ToBoolean(MPWarriorArmsSaved.BerserkerRage))
    checkButton_BattleShout:SetChecked( ToBoolean(MPWarriorArmsSaved.BattleShout) )
    checkButton_Whirlwind:SetChecked( ToBoolean(MPWarriorArmsSaved.Whirlwind) )
    checkButton_UseExecute:SetChecked( ToBoolean(MPWarriorArmsSaved.UseExecute) )
    checkButton_Charge:SetChecked( ToBoolean(MPWarriorArmsSaved.Charge) )

    checkButton_Trinket_Upper:SetChecked(ToBoolean(MPWarriorArmsSaved.Trinket_Upper))
    checkButton_TUBoss:SetChecked(ToBoolean(MPWarriorArmsSaved.TUBoss))
    checkButton_Trinket_Below:SetChecked(ToBoolean(MPWarriorArmsSaved.Trinket_Below))
    checkButton_TBBoss:SetChecked(ToBoolean(MPWarriorArmsSaved.TBBoss))

    checkButton_Target:SetChecked(ToBoolean(MPWarriorArmsSaved.Target))
    checkButton_NearbyEnemies:SetChecked(ToBoolean(MPWarriorArmsSaved.NearbyEnemies))
...
local function InitWarriorArmsSettingsPart2()
    checkButton_HealthStone:SetChecked(ToBoolean(MPWarriorArmsSaved.HealthStone))
    slider_HealthStone:SetValue(MPWarriorArmsSaved.HealthStone_Value)
    if MPWarriorArmsSaved.HealthStone==1 then
        color_HealthStone = "|cFFFFD100"
    else
        color_HealthStone = "|cFF888888"
    end
    ...
    checkButton_HerbalTea:SetChecked(MPWarriorArmsSaved.HerbalTea)
    slider_HerbalTea:SetValue(MPWarriorArmsSaved.HerbalTea_Value)
    if MPWarriorArmsSaved.HerbalTea==1 then
        color_HerbalTea = "|cFFFFD100"
    else
        color_HerbalTea = "|cFF888888"
    end
    ...
    checkButton_Carrot:SetChecked(MPWarriorArmsSaved.Carrot)
    slider_Carrot:SetValue(MPWarriorArmsSaved.Carrot_Value)
    if MPWarriorArmsSaved.Carrot==1 then
        color_Carrot = "|cFFFFD100"
    else
        color_Carrot = "|cFF888888"
    end
    ...
    checkButton_HeroicStrike:SetChecked(MPWarriorArmsSaved.HeroicStrike)
    slider_HeroicStrike:SetValue(MPWarriorArmsSaved.HeroicStrike_Value)
    ...
    slider_Slam:SetValue(MPWarriorArmsSaved.Slam_Value)
    _G[slider_Slam:GetName().."Text"]:SetText("猛击 >"..string.format("%.1f", MPWarriorArmsSaved.Slam_Value).."秒 下一次普攻")

    -- 横扫
    checkButton_Sweeping:SetChecked(MPWarriorArmsSaved.Sweeping)
    slider_Sweeping:SetValue(MPWarriorArmsSaved.Sweeping_Value)
    if MPWarriorArmsSaved.Sweeping==1 then
        color_Sweeping = "|cFFFFD100"
    else
        color_Sweeping = "|cFF888888"
    end
    ...
    checkButton_Overpower:SetChecked(MPWarriorArmsSaved.Overpower)
    slider_Overpower:SetValue(MPWarriorArmsSaved.Overpower_Value)
    if MPWarriorArmsSaved.Overpower==1 then
        color_Overpower = "|cFFFFD100"
    else
        color_Overpower = "|cFF888888"
    end
...
function MPInitWarriorArmsSettings()
    ...
    --[[
    slider_Arms_HeroicStrike:SetValue(MPWarriorArmsSaved.Arms_HeroicStrike)
    _G[slider_Arms_HeroicStrike:GetName().."Text"]:SetText("武器 英勇/顺劈 >"..MPWarriorArmsSaved.Arms_HeroicStrike.." 怒气")
    ]]


    --[[
    checkButton_Rend:SetChecked(MPWarriorArmsSaved.Rend)
    slider_Rend:SetValue(MPWarriorArmsSaved.Rend_Value)
    if MPWarriorArmsSaved.Rend==1 then
        color_Rend = "|cFFFFD100"
    else
        color_Rend = "|cFF888888"
    end
    _G[slider_Rend:GetName().."Text"]:SetText(color_Rend.."怒气 < ".. MPWarriorArmsSaved.Rend_Value)
    ]]

    --checkButton_Hamstring:SetChecked(ToBoolean(MPWarriorArmsSaved.Hamstring))


    checkButton_Interrupt:SetChecked(ToBoolean(MPWarriorArmsSaved.Interrupt))
    checkButton_Soulspeed:SetChecked(ToBoolean(MPWarriorArmsSaved.Soulspeed))
    checkButton_DeathWish:SetChecked(ToBoolean(MPWarriorArmsSaved.DeathWish))
    --checkButton_Recklessness:SetChecked(ToBoolean(MPWarriorArmsSaved.Recklessness))
    checkButton_RacialTraits:SetChecked(ToBoolean(MPWarriorArmsSaved.RacialTraits))
    checkButton_ExecuteWithMortal:SetChecked(ToBoolean(MPWarriorArmsSaved.ExecuteWithMortal))
    checkButton_ExecuteOtherTarget:SetChecked(ToBoolean(MPWarriorArmsSaved.ExecuteOtherTarget))
    checkButton_ExecuteWithoutMonster:SetChecked(ToBoolean(MPWarriorArmsSaved.ExecuteWithoutMonster))
    checkButton_SunderArmor:SetChecked(ToBoolean(MPWarriorArmsSaved.SunderArmor))
    checkButton_SunderArmorBOSS:SetChecked(ToBoolean(MPWarriorArmsSaved.SunderArmorBOSS))
    checkButton_SunderArmorOnce:SetChecked(ToBoolean(MPWarriorArmsSaved.SunderArmorOnce))

    checkButton_Power:SetChecked(ToBoolean(MPWarriorArmsSaved.Power))
    checkButton_Pick:SetChecked(ToBoolean(MPWarriorArmsSaved.Pick))
end
