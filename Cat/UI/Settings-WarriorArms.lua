...
slider_NearbyEnemies_Value:SetScript("OnValueChanged", function()
    ...
    MPWarriorArmsSaved.NearbyEnemies_Value = arg1
    _G[slider_NearbyEnemies_Value:GetName().."Text"]:SetText(color_NearbyEnemies.."感应范围".. MPWarriorArmsSaved.NearbyEnemies_Value .."码|r")
end)
...
-- 配置文件版本号
local WarriorArmsSettingsUIVersion = 22
...
function MPResetWarriorArmsSettings()
    ...
    MPWarriorArmsSaved.Target = 0
    MPWarriorArmsSaved.NearbyEnemies = 1
    MPWarriorArmsSaved.NearbyEnemies_Value = 8
...
local function InitWarriorArmsSettingsPart1()
    ...
    slider_NearbyEnemies_Value:SetValue(MPWarriorArmsSaved.NearbyEnemies_Value)
