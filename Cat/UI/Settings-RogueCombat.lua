...
local checkButton_TUBoss = MPCreateCheckButtonSmall(CatUISettingsRogueCombat, ADDON_NAME.."CheckButton", 520, postion_y, "仅BOSS")
...
local checkButton_TBBoss = MPCreateCheckButtonSmall(CatUISettingsRogueCombat, ADDON_NAME.."CheckButton", 520, postion_y, "仅BOSS")
...
local checkButton_Power = MPPublicCheckButton(CatUISettingsRogueCombat, ADDON_NAME.."CheckButton", 20, 40, "启动 功能药水")
...
local ButtonPower = MPPublicButton(CatUISettingsRogueCombat, ADDON_NAME.."CheckButton", "设置", 150, 34, 80, 22)
...
local checkButton_Pick = MPPublicCheckButton(CatUISettingsRogueCombat, ADDON_NAME.."CheckButton", 340, 40, "启动 自动拾取")
...
local ButtonPick = MPPublicButton(CatUISettingsRogueCombat, ADDON_NAME.."CheckButton", "设置", 405, 34, 80, 22)
...
-- 配置文件版本号
local RogueCombatSettingsUIVersion = 10
...
function MPResetRogueCombatSettings()
    ...
    MPRogueCombatSaved.BladeFlurry = 0
    MPRogueCombatSaved.BladeFlurry_Value = 1
    MPRogueCombatSaved.Protect = 0
    MPRogueCombatSaved.SinisterStrike = 1
