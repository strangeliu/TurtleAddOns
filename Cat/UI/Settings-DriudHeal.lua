...
local checkButton_Power = MPPublicCheckButton(CatUISettingsDriudHealWindow, ADDON_NAME.."CheckButton", 20, 40, "启动 功能药水")
...
local ButtonPower = MPPublicButton(CatUISettingsDriudHealWindow, ADDON_NAME.."CheckButton", "设置", 150, 34, 80, 22)
...
local checkButton_Pick = MPPublicCheckButton(CatUISettingsDriudHealWindow, ADDON_NAME.."CheckButton", 340, 40, "启动 自动拾取")
...
local ButtonPick = MPPublicButton(CatUISettingsDriudHealWindow, ADDON_NAME.."CheckButton", "设置", 405, 34, 80, 22)
