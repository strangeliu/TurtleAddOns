...
local checkButton_TUBoss = MPCreateCheckButtonSmall(CatUISettingsCatWindow, ADDON_NAME.."CheckButton", 520, postion_y, "仅BOSS")
...
local checkButton_TBBoss = MPCreateCheckButtonSmall(CatUISettingsCatWindow, ADDON_NAME.."CheckButton", 520, postion_y, "仅BOSS")
...
local myButton = MPCreateButton(CatUISettingsCatWindow, ADDON_NAME.."ButtonReset", "恢复默认值", 120, -44, 100, 22)
...
local checkButton_Power = MPPublicCheckButton(CatUISettingsCatWindow, ADDON_NAME.."CheckButton", 20, 40, "启动 功能药水")
...
local ButtonPower = MPPublicButton(CatUISettingsCatWindow, ADDON_NAME.."CheckButton", "设置", 150, 34, 80, 22)
...
local checkButton_Pick = MPPublicCheckButton(CatUISettingsCatWindow, ADDON_NAME.."CheckButton", 340, 40, "启动 自动拾取")
...
local ButtonPick = MPPublicButton(CatUISettingsCatWindow, ADDON_NAME.."CheckButton", "设置", 405, 34, 80, 22)
