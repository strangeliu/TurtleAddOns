...
function MPRefreshInfoUI()
    ...
    elseif t and not MPIsDrain() then
        Text = Text .. "\n"..MPLanguage.UI_Mon_TargetDrain.." |cFFff5c36"..MPLanguage.UI_Mon_CannotDrain.."|r"
    else
    ...
    if MPPlayerLevel >= 60 then
        Text = Text .. "   "..MPLanguage.UI_Mon_Level ..MPPlayerLevel .. "\n"
    else
        Text = Text .. "   |cFFff5c36"..MPLanguage.UI_Mon_Level ..MPPlayerLevel .. " "..MPLanguage.UI_Mon_NotSupported.."|r\n"
    end
    ...
    if englishClass == "DRUID" then
        ...
        if MPGetRipDot() then
            if MP_SuperWoW or MP_Nampower4 then
                ...
                if check[guid] then
                    Text = Text .. "\n"..MPLanguage.Rip.."… "..string.format("%.1f", MPDriudRipDuration-(GetTime()-check[guid])).."  "..MPLanguage.UI_Mon_Tick.." "..string.format("%.1f",MPDriudRipJumpTimer-GetTime())
                else
                    Text = Text .. "\n"..MPLanguage.Rip.."… |cFF888888"..MPLanguage.UI_Mon_InactiveDuration..MPDriudRipDuration..MPLanguage.UI_Mon_Seconds.."|r"
                end
            else
                Text = Text .. "\n"..MPLanguage.Rip.."… |cFF6dff7b"..MPLanguage.UI_Mon_Active.."|r".."  "..MPLanguage.UI_Mon_Tick.." "..string.format("%.1f",MPDriudRipJumpTimer-GetTime())
            end
        else
            Text = Text .. "\n"..MPLanguage.Rip.."… |cFF888888"..MPLanguage.UI_Mon_InactiveDuration..MPDriudRipDuration..MPLanguage.UI_Mon_Seconds.."|r"
        end
