...
local checkButton_TUBoss = MPCreateCheckButtonSmall(CatUISettingsHunterMelee, ADDON_NAME.."CheckButton", 520, postion_y, "仅BOSS")
...
local checkButton_TBBoss = MPCreateCheckButtonSmall(CatUISettingsHunterMelee, ADDON_NAME.."CheckButton", 520, postion_y, "仅BOSS")
...
local checkButton_Power = MPPublicCheckButton(CatUISettingsHunterMelee, ADDON_NAME.."CheckButton", 20, 40, "启动 功能药水")
...
local ButtonPower = MPPublicButton(CatUISettingsHunterMelee, ADDON_NAME.."CheckButton", "设置", 150, 34, 80, 22)
...
local checkButton_Pick = MPPublicCheckButton(CatUISettingsHunterMelee, ADDON_NAME.."CheckButton", 340, 40, "启动 自动拾取")
...
local ButtonPick = MPPublicButton(CatUISettingsHunterMelee, ADDON_NAME.."CheckButton", "设置", 405, 34, 80, 22)
