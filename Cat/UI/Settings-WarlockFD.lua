...
local checkButton_TUBoss = MPCreateCheckButtonSmall(CatUISettingsWarlockFD, ADDON_NAME.."CheckButton", 520, postion_y, "仅BOSS")
...
local checkButton_TBBoss = MPCreateCheckButtonSmall(CatUISettingsWarlockFD, ADDON_NAME.."CheckButton", 520, postion_y, "仅BOSS")
...
local checkButton_Power = MPPublicCheckButton(CatUISettingsWarlockFD, ADDON_NAME.."CheckButton", 20, 40, "启动 功能药水")
...
local ButtonPower = MPPublicButton(CatUISettingsWarlockFD, ADDON_NAME.."CheckButton", "设置", 150, 34, 80, 22)
...
local checkButton_Pick = MPPublicCheckButton(CatUISettingsWarlockFD, ADDON_NAME.."CheckButton", 340, 40, "启动 自动拾取")
...
local ButtonPick = MPPublicButton(CatUISettingsWarlockFD, ADDON_NAME.."CheckButton", "设置", 405, 34, 80, 22)
