...
CharStats_base = {
	...
	{ race = "Dwarf", class = "WARRIOR", level = 60,
	  ...
	  ar = 0, fr = 0, nr = 0, ir = 10, sr=0,
	  health = 2639, mana = 0 },
	{ race = "Dwarf", class = "MAGE", level = 60,
	...
	{ race = "Gnome", class = "WARRIOR", level = 60,
	  ...
	  ar = 10, fr = 0, nr = 0, ir = 0, sr=0,
	  health = 2599, mana = 0 },
	{ race = "Gnome", class = "HUNTER", level = 60, 
	  str = 57, agi = 121, sta = 93, int = 67, spi = 69,
	  ar = 10, fr = 0, nr = 0, ir = 0, sr=0,
	  health = 2217, mana = 2445 }, 
	...
	{ race = "Human", class = "WARRIOR", level = 60,
	  ...
	  ar = 0, fr = 0, nr = 0, ir = 0, sr=0,
	  health = 2609, mana = 0 },
	{ race = "Human", class = "HUNTER", level = 60,
	  str = 52, agi = 130, sta = 89, int = 65, spi = 73,
	  ar = 0, fr = 0, nr = 10, ir = 0, sr=0,
	...
	{ race = "Troll", class = "WARRIOR", level = 60,
	  ...
	  ar = 0, fr = 0, nr = 0, ir = 0, sr=0,
	  health = 2619, mana = 0 },
	{ race = "Troll", class = "WARLOCK", level = 60,
	  str = 48, agi = 47, sta = 67, int = 107, spi = 118,
	  ar = 0, fr = 0, nr = 0, ir = 0, sr= 0,
	  health = 1904, mana = 2698 },
	...
	{ race = "Scourge", class = "WARRIOR", level = 60,
	  ...
	  ar = 0, fr = 0, nr = 0, ir = 0, sr=10,
	  health = 2619, mana = 0 },
	{ race = "Scourge", class = "HUNTER", level = 60,
	  str = 56, agi = 127, sta = 91, int = 61, spi = 71,
	  ar = 0, fr = 0, nr = 0, ir = 0, sr= 10,
	  health = 2197, mana = 2355 },
	  
	 --Add for turtle new race 
	{ race = "BloodElf", class = "WARRIOR", level = 60,
	  str = 123, agi = 77, sta = 112, int = 27, spi = 48,
	  ar = 0, fr = 0, nr = 0, ir = 0, sr=0,
	  health = 2629, mana = 0 },
	{ race = "BloodElf", class = "ROGUE", level = 60,
	  str = 83, agi = 127, sta = 77, int = 32, spi = 53,
	  ar = 0, fr = 0, nr = 0, ir = 0, sr=0,
	  health = 2113, mana = 0 },
	{ race = "BloodElf", class = "HUNTER", level = 60,
	  str = 58, agi = 122, sta = 92, int = 62, spi = 73,
	  ar = 0, fr = 0, nr = 0, ir = 0, sr=0,
	  health = 2207, mana = 2370 },
	{ race = "BloodElf", class = "PALADIN", level = 60,
	  str = 105, agi = 65, sta = 100, int = 70, spi = 78,
	  ar = 0, fr = 0, nr = 0, ir = 0, sr=0,
	  health = 2201, mana = 2282 },
	{ race = "BloodElf", class = "PRIEST", level = 60,
	  str = 35, agi = 40, sta = 50, int = 120, spi = 131,
	  ar = 0, fr = 0, nr = 0, ir = 0, sr=0,
	  health = 1717, mana = 2896 },
	{ race = "BloodElf", class = "MAGE", level = 60,
	  str = 30, agi = 35, sta = 45, int = 125, spi = 126,
	  ar = 0, fr = 0, nr = 0, ir = 0, sr=0,
	  health = 1640, mana = 2808 },
	  
	{ race = "Goblin", class = "WARRIOR", level = 60,
	  str = 123, agi = 77, sta = 112, int = 27, spi = 48,
	  ar = 0, fr = 0, nr = 0, ir = 0, sr=0,
	  health = 2629, mana = 0 }, 
	{ race = "Goblin", class = "ROGUE", level = 60,
	  str = 83, agi = 127, sta = 77, int = 32, spi = 53,
	  ar = 0, fr = 0, nr = 0, ir = 0, sr=0,
	  health = 2113, mana = 0 }, 
	{ race = "Goblin", class = "HUNTER", level = 60,
	  str = 58, agi = 122, sta = 92, int = 62, spi = 73,
	  ar = 0, fr = 0, nr = 0, ir = 0, sr=0,
	  health = 2207, mana = 2370 },
	{ race = "Goblin", class = "MAGE", level = 60,
	  str = 30, agi = 35, sta = 45, int = 125, spi = 126,
	  ar = 0, fr = 0, nr = 0, ir = 0, sr=0,
	  health = 1640, mana = 2808 },
	{ race = "Goblin", class = "WARLOCK", level = 60,
	  str = 48, agi = 47, sta = 66, int = 107, spi = 118,
	  ar = 0, fr = 0, nr = 0, ir = 0, sr=0,
	  health = 1894, mana = 2698 },
...
CHARSTAT_EFFECTS = {
	...
	{ effect = "DAMAGEREDUCEV60",	name = STATCOMPARE_DAMAGEREDUCEV60},
	{ effect = "DAMAGEREDUCEV63",	name = STATCOMPARE_DAMAGEREDUCEV63},
...
function StatCompare_CharStats_Scan(bonuses, unit)
	...
	if race == "BloodElf" then
		CharStats_basevals["AGI"] = CharStats_basevals["AGI"] * 1.02
	end
	...
	--REQ20250316:Damage reduce should have a cap
	local damageReduceUpperLimit = 75;
	-- DR = 100 * Armor / ( Armor + 85*level + 400 )
	
	local ac = 0
	if unit == "player" then
		_, ac = UnitArmor("player")
	else
		if bonuses["ARMOR"] then 
			ac = bonuses["ARMOR"]
		elseif CharStats_fullvals["ARMOR"] then
			ac = CharStats_fullvals["ARMOR"]
		end
	end	
	
	if ac == 0 and bonuses["ENARMOR"] then
		ac = bonuses["ENARMOR"]
	end
	
	value = 100 * ac / (ac + 85 * UnitLevel("player") + 400);
	
	if value > damageReduceUpperLimit then value = damageReduceUpperLimit end
	CharStats_fullvals["DAMAGEREDUCEV60"] = format("%.2f",value);

	-- DR = 100 * Armor / ( Armor + 85*level + 400 )
	value = 100 * ac / (ac + 85 * 63 + 400);
	if value > damageReduceUpperLimit then value = damageReduceUpperLimit end
	CharStats_fullvals["DAMAGEREDUCEV63"] = format("%.2f",value);

	--test only
	value="9999";
	CharStats_fullvals["EXAMPLE"] =  format("%.2f",value);
	...
	if unit == "player" then
		local base_attackpower, posBuff_ap, negBuff_ap = UnitAttackPower("player");
		CharStats_fullvals["ATTACKPOWER"] = base_attackpower + posBuff_ap + negBuff_ap;
	end
	...
	if unit=="player" then
		local base_rap, posBuff_rap, negBuff_rap = UnitRangedAttackPower(unit);
		CharStats_fullvals["RANGEDATTACKPOWER"] = base_rap + posBuff_rap - negBuff_rap
	end
	...
	if (class == "HUNTER" or class == "WARRIOR" or class == "ROGUE") then
		...
		CharStats_fullvals["RANGEDCRIT"] = 0;
		CharStats_fullvals["RANGEDHIT"] = 0;

	end

	-- deal MELEE_WITH_RANGED_ATTACK_POWER


	CharStats_fullvals["MELEE_WITH_RANGED_ATTACK_POWER"] = CharStats_fullvals["ATTACKPOWER"] .." / " .. CharStats_fullvals["RANGEDATTACKPOWER"] ;


	--deal MELEE_WITH_RANGED_HIT
	-- Parry
	value = 0;
	...
	fvalue = 0.00
	if (race == "NightElf") then
		if bonuses["HASTE"] then
			fvalue = ( 1.01 * (bonuses["HASTE"] / 100 + 1) -1 ) * 100;
		else
			fvalue = 1.01;
		end
		CharStats_fullvals["HASTE"] = fvalue;
	end
	...
	local weaponSkill = GetCurrentWeaponSkill()
	...
	elseif(class == "PALADIN") then
		...
		--value = 0.82 + CharStats_fullvals["AGI"]/20 ; -- sth wrong
	elseif(class == "WARLOCK") then
	...
	--deal MELEE_WITH_RANGED_CRIT

	if unit=="player" then
		if IsAddOnLoaded("BetterCharacterStats") then
			CharStats_fullvals["CRIT"] = BCS:GetCritChance()
		else
			CharStats_fullvals["CRIT"] = tonumber(StatCompare_CharStats_GetCritChance())
		end
	end

	if CharStats_fullvals["RANGEDCRIT"] and tonumber(CharStats_fullvals["RANGEDCRIT"]) < tonumber(CharStats_fullvals["CRIT"]) then
		if (class == "PALADIN" or class == "SHAMAN" or class == "DRUID") then
			CharStats_fullvals["RANGEDCRIT"] = 0
		else
			CharStats_fullvals["RANGEDCRIT"] = CharStats_fullvals["CRIT"]
		end
	end
	if CharStats_fullvals["RANGEDCRIT"]  then 
		CharStats_fullvals["MELEE_WITH_RANGED_CRIT"] = string.format("%.2f",CharStats_fullvals["CRIT"]) .."% / " .. string.format("%.2f",CharStats_fullvals["RANGEDCRIT"]).."%" ;
	else
		CharStats_fullvals["MELEE_WITH_RANGED_CRIT"] = string.format("%.2f",CharStats_fullvals["CRIT"]) .."% / "..string.format("%.2f",CharStats_fullvals["CRIT"]).."%" ;
	end
	--sth wrong

	--deal MELEE_WITH_RANGED_HIT
	if bonuses["TOHIT"] then 
		CharStats_fullvals["TOHIT"] = bonuses["TOHIT"]
	else 
		CharStats_fullvals["TOHIT"] = 0
	end
	if bonuses["RANGEDTOHIT"] then
		CharStats_fullvals["RANGEDTOHIT"] = bonuses["RANGEDTOHIT"] + CharStats_fullvals["TOHIT"]
	else
		CharStats_fullvals["RANGEDTOHIT"] = CharStats_fullvals["TOHIT"]
	end
	if (class == "PALADIN" or class == "SHAMAN" or class == "DRUID")
		then CharStats_fullvals["RANGEDTOHIT"] = 0
	end

	if CharStats_fullvals["RANGEDHIT"] then
		CharStats_fullvals["MELEE_WITH_RANGED_HIT"] = "+"..CharStats_fullvals["TOHIT"] .."% / +".. CharStats_fullvals["RANGEDHIT"].."%"; 
	else 
		CharStats_fullvals["MELEE_WITH_RANGED_HIT"] = "+"..CharStats_fullvals["TOHIT"] .."% / +"..CharStats_fullvals["TOHIT"] .."%";
	end
	...
	--casting mana reg -human
	if (race == "Human") then
		if bonuses["CASTING_MANA_REG"] then
			bonuses["CASTING_MANA_REG"] = bonuses["CASTING_MANA_REG"] + 5
		end
	end

end

function GetCurrentWeaponSkill()
	local weaponSkill = 0;
	local tar
	local weaponType
	local itemType
	...
	local hasItem = GetInventoryItemLink(tar,16)
	if hasItem then 
		local _, _, itemID = string.find(hasItem, "item:(%d+):%d+:%d+:%d+")
		local n = tonumber(itemID)
		_, _, _, _, _,itemType = GetItemInfo(n)

	else itemType = "ͽ��ս��"
	end
	local skillname
	local weapontable ={
		WEAPONSKILL_DAGGER		= "ذ��",
		WEAPONSKILL_FIST		= "ͽ��ս��",
		WEAPONSKILL_ONEHAND_MACE	= "���ִ�",
		WEAPONSKILL_ONEHAND_SWORD	= "���ֽ�",
		WEAPONSKILL_ONEHAND_AXE	= "���ָ�",
		WEAPONSKILL_TWOHAND_AXE	= "˫�ָ�",
		WEAPONSKILL_TWOHAND_SWORD	= "˫�ֽ�",
		WEAPONSKILL_TWOHAND_MACE	= "˫�ִ�",
		WEAPONSKILL_POLEARMS	= "��������",
	}
	...
	if (race == "Human") then
		if bonuses["WEAPONSKILL_TWOHAND_SWORD"] then
			bonuses["WEAPONSKILL_TWOHAND_SWORD"] = bonuses["WEAPONSKILL_TWOHAND_SWORD"] + 3
		end
		if bonuses["WEAPONSKILL_ONEHAND_SWORD"] then
			bonuses["WEAPONSKILL_ONEHAND_SWORD"] = bonuses["WEAPONSKILL_ONEHAND_SWORD"] + 3
		end
		if bonuses["WEAPONSKILL_TWOHAND_MACE"] then
			bonuses["WEAPONSKILL_TWOHAND_MACE"] = bonuses["WEAPONSKILL_TWOHAND_MACE"] + 3
		end
		if bonuses["WEAPONSKILL_ONEHAND_MACE"] then
			bonuses["WEAPONSKILL_ONEHAND_MACE"] = bonuses["WEAPONSKILL_ONEHAND_MACE"] + 3
		end
	elseif (race == "Orc") then 
		if bonuses["WEAPONSKILL_TWOHAND_AXE"] then
			bonuses["WEAPONSKILL_TWOHAND_AXE"] = bonuses["WEAPONSKILL_TWOHAND_AXE"] + 3
		end
		if bonuses["WEAPONSKILL_TWOHAND_AXE"] then
			bonuses["WEAPONSKILL_TWOHAND_AXE"] = bonuses["WEAPONSKILL_TWOHAND_AXE"] + 3
		end
