...
function CandyBar:SetGradient(name, c1, c2, c3, c4, c5, c6, c7, c8, c9, c10)
	...
	if c7 then
		gtable[7] = {}
		-- FIX Bug5: 原代码为 gtable[3][2]，应为 gtable[7][2]，导致第7个渐变色绿色分量被写入错误位置
		_, gtable[7][1], gtable[7][2], gtable[7][3] = paint:GetRGBPercent(c7)
	end
	if c8 then
		gtable[8] = {}
...
CandyBar.UpdateCandyBarSpacing = CandyBar.UpdateBarSpacing
