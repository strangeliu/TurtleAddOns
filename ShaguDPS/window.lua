...
local menubuttons = {
  -- segments
  ["Current"]  = { 0, 1, -25.5, "当前战斗", "|cffffffff显示当前战斗的数据",      "segment" },
  ["Overall"]  = { 1, 0, -25.5, "全程数据", "|cffffffff显示全程的总数据",         "segment" },

  -- modes
  ["Damage"]   = { 0, 1, 25.5,  "伤害量",     "|cffffffff显示伤害量",        "view" },
  ["DPS"]      = { 1, 2, 25.5,  "每秒伤害",        "|cffffffff显示每秒伤害",  "view" },
  ["Heal"]     = { 2, 3, 25.5,  "治疗量",       "|cffffffff显示治疗量",       "view" },
  ["HPS"]      = { 3, 4, 25.5,  "每秒治疗",        "|cffffffff显示每秒治疗",    "view" },
}
...
local function Refresh(self, force, report)
  ...
  if force then
    ...
    if config[wid].view == 1 then
      ...
      self.btnMode.caption:SetText("伤害量")
    ...
    elseif config[wid].view == 3 then
      ...
      self.btnMode.caption:SetText("治疗量")
...
local function CreateWindow(wid)
  ...
  frame.btnSegment.caption:SetText("全程")
  frame.btnSegment.caption:SetAllPoints()
  frame.btnSegment.tooltip = { "选择时间段", "|cffffffff全程, 当前" }
  ...
  frame.btnMode.caption:SetText("模式：伤害量")
  frame.btnMode.caption:SetAllPoints()
  frame.btnMode.tooltip = { "选择模式", "|cffffffff伤害量, DPS, 治疗量, HPS" }
  ...
  frame.btnReset.tooltip = {
    "清空数据",
    { "|cffffffff点击", "|cffaaaaaa询问清空数据"},
    { "|cffffffffShift+点击", "|cffaaaaaa直接清空数据"},
  }
