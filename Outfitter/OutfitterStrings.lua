...
Outfitter_cItemStatFormats = {
    ...
    -- 新增游泳属性识别
    { Format = "Increases swim speed by (%d+)%%", Types = { "Swimming" } },
    { Format = "Allows you to breathe underwater", Value = 1, Types = { "Swimming" } },
    { Format = "Slightly increases run and swim speed", Value = 8, Types = { "Swimming" } },
};
...
Outfitter_cHunterWolf = "Hunter: Wolf";
...
Outfitter_cAspectOfTheWolf = "Aspect of the Wolf";
Outfitter_cEvocate = "Evocation";

Outfitter_cCritter = "Critter";

Outfitter_cCompleteCategoryDescription = "Complete outfits have items specified for every slot and will replace all other outfits when worn.";
