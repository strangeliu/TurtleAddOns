	...
	if not selected_item then
        ...
        do
            ...
            if not unit_vendor_price then
                vendor_price_label:SetText("商人售价：无")
            elseif unit_vendor_price == 0 then
                vendor_price_label:SetText("商人售价：无")
            else
                vendor_price_label:SetText("商人售价：" .. money.to_string(unit_vendor_price, nil, nil, aux.color.text.enabled))
            end
        end
