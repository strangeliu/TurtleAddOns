...
M.print = T.vararg-function(arg)
	DEFAULT_CHAT_FRAME:AddMessage(LIGHTYELLOW_FONT_COLOR_CODE .. '' .. join(map(arg, tostring), ' '))
end
...
do
	...
	event_frame:SetScript('OnEvent', function()
		...
		elseif event == 'PLAYER_LOGIN' then
			...
			print('|cff00ffff拍卖增强 已加载|r /aux')
			DEFAULT_CHAT_FRAME:AddMessage(LIGHTYELLOW_FONT_COLOR_CODE .. 'aux拍卖增强现在新增了一个仿暴雪风格的主题。如需切换主题，请使用命令 /aux theme')
		else
			_M[event]()
		end
	end)
