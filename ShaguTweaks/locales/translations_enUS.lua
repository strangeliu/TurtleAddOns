...
ShaguTweaks_translation["enUS"] = {
  ...
  ["Super WoW Compatibility"] = nil,
  ["Adds compatibility for the SuperWoW client mod."] = nil,
  ["More Buffs & Debuffs"] = nil,
  ["Extends the target frame to display up to 32 buffs and debuffs with improved layout."] = nil,
