...
function MMM_GUI.InitializeWorldMapControls()
    ...
    local SCROLL_FRAME_WIDTH = PANEL_WIDTH - PANEL_PADDING * 2 - 22

    local LVL_TEXT_RESERVED_WIDTH = 50
    local NAME_TEXT_WIDTH = SCROLL_FRAME_WIDTH - LVL_TEXT_RESERVED_WIDTH - 8
    ...
    for i = 1, MAX_VISIBLE_ROWS do
        ...
        nameText:SetWidth(NAME_TEXT_WIDTH)
    ...
    local function RefreshFindList()
        ...
        for i = 1, MAX_VISIBLE_ROWS do
            ...
            if dataIndex <= totalRows then
                ...
                row.nameText:SetWidth(NAME_TEXT_WIDTH)
