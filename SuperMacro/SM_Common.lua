...
function SuperMacroUpdateConfig()
    ...
    -- SuperMacroFrame
    SuperMacroFrameScrollFrame:SetWidth(superEditScrollFrameSizeX)
    SuperMacroFrameScrollFrame:SetHeight(superEditScrollFrameSizeY)

    SuperMacroFrameTextBackground:SetWidth(superEditScrollFrameSizeX + 36)
    SuperMacroFrameTextBackground:SetHeight(superEditScrollFrameSizeY + 12)

    SuperMacroFrameText:SetWidth(superEditScrollFrameSizeX - 1)
    SuperMacroFrameText:SetHeight(superEditScrollFrameSizeY)
