...
local function RefreshFrameColorVisuals()
    if sRaidFrames and sRaidFrames.enabled then
        sRaidFrames:UpdateAllBuffs()
...
local function RefreshAggroVisuals()
    RefreshFrameColorVisuals()
end
    ...
    args = {
        ...
        pure_view = {
            ...
            args = {
                ...
                debuff_aura_colors = {
                    name = L["Debuff aura colors"],
                    type = "group",
                    desc = L["Toggle debuff background color schemes"],
                    order = 5,
                    args = {
                        curse = {
                            name = L["Curse aura"],
                            type = "toggle",
                            desc = L["Enable/Disable background color change for curse debuffs"],
                            get = function()
                                return sRaidFrames.opt.debuff_aura_curse ~= false
                            end,
                            set = function(value)
                                sRaidFrames:S("debuff_aura_curse", value)
                                RefreshFrameColorVisuals()
                            end,
                            disabled = function()
                                return sRaidFrames.opt.unit_debuff_aura
                        ...
                        magic = {
                            name = L["Magic aura"],
                            type = "toggle",
                            desc = L["Enable/Disable background color change for magic debuffs"],
                            get = function()
                                return sRaidFrames.opt.debuff_aura_magic ~= false
                            end,
                            set = function(value)
                                sRaidFrames:S("debuff_aura_magic", value)
                                RefreshFrameColorVisuals()
                            end,
                            disabled = function()
                                return sRaidFrames.opt.unit_debuff_aura
                        ...
                        disease = {
                            name = L["Disease aura"],
                            type = "toggle",
                            desc = L["Enable/Disable background color change for disease debuffs"],
                            get = function()
                                return sRaidFrames.opt.debuff_aura_disease ~= false
                            end,
                            set = function(value)
                                sRaidFrames:S("debuff_aura_disease", value)
                                RefreshFrameColorVisuals()
                            end,
                            disabled = function()
                                return sRaidFrames.opt.unit_debuff_aura
                        ...
                        poison = {
                            name = L["Poison aura"],
                            type = "toggle",
                            desc = L["Enable/Disable background color change for poison debuffs"],
                            get = function()
                                return sRaidFrames.opt.debuff_aura_poison ~= false
                            end,
                            set = function(value)
                                sRaidFrames:S("debuff_aura_poison", value)
                                RefreshFrameColorVisuals()
                            end,
                            disabled = function()
                                return sRaidFrames.opt.unit_debuff_aura
        ...
        srfhideparty = {
            ...
            set = function(value)
                ...
                sRaidFrames:UpdateParty()
            end,
        },
        showInParty = {
            name = L["Show In Party"],
            type = "toggle",
            desc = L["Show sRaidFrames in party"],
            order = 99,
            get = function()
                return sRaidFrames.opt.showInParty
            end,
            set = function(value)
                sRaidFrames:S("showInParty", value)
        ...
        showInSolo = {
            name = L["Show In Solo"],
            type = "toggle",
            desc = L["Show sRaidFrames when solo"],
            order = 100,
            get = function()
                return sRaidFrames.opt.showInSolo
            end,
            set = function(value)
                sRaidFrames:S("showInSolo", value)
                if not UnitInRaid("player") and not UnitExists("party1") then
                    sRaidFrames:UpdateRoster()
                end
            end,
        },
...
-- 新增↓↓↓
        raidmarker = {
            ...
            args = {
                raidmarker_onable = {
                    name = L["Enable raidmarker"],
                    type = "toggle",
                    desc = L
                    ["Whether to display raidmarker"],
                    get = function()
                        return sRaidFrames.opt.raidmarker_onable
                    end,
                    set = function(set)
                        sRaidFrames:S("raidmarker_onable", set)
                        sRaidFrames:LoadStyle()
                ...
                raidmarker_size = {
                    name = L["Raidmarker texture size"],
                    type = "range",
                    desc = L["Set size of raidmarker texture"],
                    min = 10,
                    max = 35,
                    step = 0.1,
                    get = function()
                        return sRaidFrames.opt.raidmarker_size
                    end,
                    set = function(set)
                        sRaidFrames:S("raidmarker_size", set)
                        sRaidFrames:LoadStyle()
                    end,
                    order = 2,
                },
				raidMarkerAlpha = {
                    name = L["Raidmarker Alpha"],
                    type = "range",
                    desc = L["Set Alpha of raidmarker texture"],
                    min = 0,
                    max = 1,
                    step = 0.05,
                    get = function()
                        return sRaidFrames.opt.raidMarkerAlpha
                    end,
                    set = function(set)
                        sRaidFrames:S("raidMarkerAlpha", set)
                        sRaidFrames:LoadStyle()
                    end,
                    order = 3,
                },
...
-- 新增↑↑↑
        ...
        debug = {
            ...
            args = {
                ...
                debug_heal = {
                    ...
                    type = "toggle",
                    desc = L
                    ["Incomming heal debug, only for testing. Prefixes: HCOM - HealComm, SRF - SRaidFrames, HBOT - HealBot, HAS - Healer Assist"],
                ...
                debug_rez = {
                    ...
                    type = "toggle",
                    desc = L
                    ["Incomming resurrection debug, only for testing. Prefixes: HCOM - HealComm, SRF - SRaidFrames, HBOT - HealBot, HAS - Healer Assist"],
        ...
        range = {
            ...
            args = {
                enable = {
                    ...
                    type = "toggle",
                    desc = L
                    ["Enable 28y range check in Instances and 40y coordinates dependant range check in Outdoors and Bgs - Suggested when you neither play healing class nor using Blizzard frames, agUnitFrames or LunaUnitFrames"],
                ...
                enable40y = {
                    ...
                    type = "toggle",
                    desc = L
                    ["Enable 40y range check that requires certain spells to be on actionbar and Blizzard frames, agUnitFrames or LunaUnitFrames to be present - Only healing classes can use accurate range check"],
                ...
                frequency2 = {
                    ...
                    type  = "range",
                    desc  = L
                    ["Increase or decrease time needed for full units scan - if you experience performance drop please increase the value"],
        ...
        border = {
            ...
            args = {
                ...
                combatbordertoggle = {
                    name = L["Orange border in combat"],
                    type = "toggle",
                    desc = L["Enable/Disable orange border highlight when unit is in combat without aggro"],
                    get = function()
                        return sRaidFrames.opt.combat_border ~= false
                    end,
                    set = function(value)
                        sRaidFrames:S("combat_border", value)
                        RefreshFrameColorVisuals()
                    end,
                    disabled = function()
                        return not sRaidFrames.opt.Border
                    end,
                    order = 3
                },
...
function sRaidFrames:chatUpdateBuffMenu()
    ...
    for buff in pairs(self.opt.BuffFilter) do
        ...
        self.options.args.buffsdebuffs.args.bufffilter.args["remove"].args["buff" .. i].desc = 'Remove ' ..
        buffName .. ' from the buff list'
        self.options.args.buffsdebuffs.args.bufffilter.args["remove"].args["buff" .. i].func = function()
...
function sRaidFrames:chatUpdateDebuffMenu()
    ...
    for debuff in pairs(self.opt.DebuffFilter) do
        ...
        self.options.args.buffsdebuffs.args.debufffilter.args["remove"].args["debuff" .. i].desc = 'Remove ' ..
        debuffName .. ' from the debuff list'
        self.options.args.buffsdebuffs.args.debufffilter.args["remove"].args["debuff" .. i].func = function()
...
function sRaidFrames:DisableRangeCheck()
    ...
    for unit in pairs(sRaidFrames.frames) do
        ...
        sRaidFrames.frames[unit].notinsightmask:Hide()
        sRaidFrames:SetCachedUnitValue(sRaidFrames.UnitRangeArray, unit, "")
        sRaidFrames:SetCachedUnitValue(sRaidFrames.UnitInSightArray, unit, nil)
        sRaidFrames:SetCachedUnitValue(sRaidFrames.UnitInCombatArray, unit, nil)
    end
    --end
...
function sRaidFrames:MultidragMsg()
    if not self.MultidragInfo then
        DEFAULT_CHAT_FRAME:AddMessage("|cff00eeee sRaidFrames: |cffffffff" ..
        "For multidrag unlock the frames and use alt + left mouse combination.");
...
function sRaidFrames:PopulateFocusMsg()
    if not self.PopulateFocusInfo then
        DEFAULT_CHAT_FRAME:AddMessage("|cff00eeee sRaidFrames: |cffffffff" ..
        "Enabling - Populate with range and Sort focus functionality may cause UI perfomance drop");
...
function sRaidFrames:BuffFilteringMsg()
    if not self.BuffsDebuffsInfo then
        DEFAULT_CHAT_FRAME:AddMessage("|cff00eeee sRaidFrames: |cffffffff" ..
        "Enabling - Buffs and Debuffs filtering at once may cause UI perfomance drop");
