...
L:RegisterTranslations("zhCN", function() return {
	...
	["Show In Solo"] = "单人时显示",
	["Show sRaidFrames in party"] = "在小队时显示团队框架",
	["Show sRaidFrames when solo"] = "单人未组队时显示团队框架",
    ...
    ["Raidmarker"] = "团队标记",
    ["Raidmarker texture size"] = "团队标记大小",
    ["Set size of raidmarker texture"] = "设置团队标记尺寸",
	["Raidmarker Alpha"] = "团队标记透明度",
    ["Set Alpha of raidmarker texture"] = "设置团队标记的透明度",
    ["Enable raidmarker"] = "显示团队标记",
    ["Whether to display raidmarker"] = "在团队框架上显示单位的团队标记",
	["Debuff aura colors"] = "Debuff底色",
	["Toggle debuff background color schemes"] = "切换Debuff背景染色方案",
	["Curse aura"] = "诅咒底色",
	["Enable/Disable background color change for curse debuffs"] = "开启/禁用 诅咒Debuff背景颜色变化",
	["Magic aura"] = "魔法底色",
	["Enable/Disable background color change for magic debuffs"] = "开启/禁用 魔法Debuff背景颜色变化",
	["Disease aura"] = "疾病底色",
	["Enable/Disable background color change for disease debuffs"] = "开启/禁用 疾病Debuff背景颜色变化",
	["Poison aura"] = "中毒底色",
	["Enable/Disable background color change for poison debuffs"] = "开启/禁用 中毒Debuff背景颜色变化",
	["Orange border in combat"] = "战斗橙色边框",
	["Enable/Disable orange border highlight when unit is in combat without aggro"] = "开启/禁用 单位处于战斗中且没有仇恨时的橙色边框高亮",
} end)
