...
TRAINERSKILLS_CHAT_LOADED = TRAINERSKILLS_GREEN_FONT_COLOR_CODE.."Razzer's TrainerSkills 版本 "..TRAINERSKILLS_VERSIONNUMBER.." 加载. 使用 /ts help 或 /trainerSkills help 查看更多信息"..TRAINERSKILLS_FONT_COLOR_CODE_CLOSE;
